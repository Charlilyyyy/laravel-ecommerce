...
<div class="profile-page" style="position:relative;z-index:-1">
  <div class="content">
...
.profile-page .content__actions button {
  display: flex;
...
@media (max-width: 990px) {
  .profile-page .content__actions button span {
    display: none;
  }
}
.profile-page .content__actions button svg {
  width: 2rem;
  margin-right: 0.4rem;
}
@media (max-width: 990px) {
...
.profile-page .content__actions button svg path:last-child {
  opacity: 0.5;
}
.profile-page .content__actions button:first-child {
  color: #ff4086;
}
.theme-orange .profile-page .content__actions button:first-child {
  color: #ff4086;
}
.theme-purple .profile-page .content__actions button:first-child {
  color: #8700ff;
}
.theme-green .profile-page .content__actions button:first-child {
  color: #1dcc45;
}
.theme-blue .profile-page .content__actions button:first-child {
  color: #0098f0;
}
.profile-page .content__actions button:last-child {
  color: #d782d9;
}
.theme-orange .profile-page .content__actions button:last-child {
  color: #fd8d76;
}
.theme-purple .profile-page .content__actions button:last-child {
  color: #f000ff;
}
.theme-green .profile-page .content__actions button:last-child {
  color: #42b883;
}
.theme-blue .profile-page .content__actions button:last-child {
  color: #00f2c3;
}
.profile-page .content__actions button:hover:first-child {
  background: #1d8cf8;
  color: #fff;
}
.theme-orange .profile-page .content__actions button:hover:first-child {
  background: #ff4086;
}
.theme-purple .profile-page .content__actions button:hover:first-child {
  background: #8700ff;
}
.theme-green .profile-page .content__actions button:hover:first-child {
  background: #1dcc45;
}
.theme-blue .profile-page .content__actions button:hover:first-child {
  background: #0098f0;
}
.profile-page .content__actions button:hover:last-child {
  background: #1d8cf8;
  color: #fff;
}
.theme-orange .profile-page .content__actions button:hover:last-child {
  background: #fd8d76;
}
.theme-purple .profile-page .content__actions button:hover:last-child {
  background: #f000ff;
}
.theme-green .profile-page .content__actions button:hover:last-child {
  background: #42b883;
}
.theme-blue .profile-page .content__actions button:hover:last-child {
  background: #00f2c3;
}
